...
class Notification(models.Model):
    ...
    fromUser = models.ForeignKey(User, on_delete=models.CASCADE, related_name="notifications_sent", null=True, blank=True)
    toUser = models.ForeignKey(User, on_delete=models.CASCADE, related_name="notifications_recived", null=True, blank=True)
